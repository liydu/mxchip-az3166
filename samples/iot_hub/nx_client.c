...
static UINT append_device_info_properties(NX_AZURE_IOT_JSON_WRITER *json_writer)
{
    if (nx_azure_iot_json_writer_append_property_with_string_value(
            json_writer, (UCHAR *)DEVICE_INFO_MANUFACTURER_PROPERTY_NAME,
            sizeof(DEVICE_INFO_MANUFACTURER_PROPERTY_NAME) - 1, (UCHAR *)DEVICE_INFO_MANUFACTURER_PROPERTY_VALUE,
            sizeof(DEVICE_INFO_MANUFACTURER_PROPERTY_VALUE) - 1) ||
        nx_azure_iot_json_writer_append_property_with_string_value(
            json_writer, (UCHAR *)DEVICE_INFO_MODEL_PROPERTY_NAME, sizeof(DEVICE_INFO_MODEL_PROPERTY_NAME) - 1,
            (UCHAR *)DEVICE_INFO_MODEL_PROPERTY_VALUE, sizeof(DEVICE_INFO_MODEL_PROPERTY_VALUE) - 1) ||
        nx_azure_iot_json_writer_append_property_with_string_value(
            json_writer, (UCHAR *)DEVICE_INFO_SW_VERSION_PROPERTY_NAME,
            sizeof(DEVICE_INFO_SW_VERSION_PROPERTY_NAME) - 1, (UCHAR *)DEVICE_INFO_SW_VERSION_PROPERTY_VALUE,
            sizeof(DEVICE_INFO_SW_VERSION_PROPERTY_VALUE) - 1) ||
        nx_azure_iot_json_writer_append_property_with_string_value(
            json_writer, (UCHAR *)DEVICE_INFO_OS_NAME_PROPERTY_NAME, sizeof(DEVICE_INFO_OS_NAME_PROPERTY_NAME) - 1,
            (UCHAR *)DEVICE_INFO_OS_NAME_PROPERTY_VALUE, sizeof(DEVICE_INFO_OS_NAME_PROPERTY_VALUE) - 1) ||
        nx_azure_iot_json_writer_append_property_with_string_value(
            json_writer, (UCHAR *)DEVICE_INFO_PROCESSOR_ARCHITECTURE_PROPERTY_NAME,
        ...
        nx_azure_iot_json_writer_append_property_with_string_value(
            json_writer, (UCHAR *)DEVICE_INFO_PROCESSOR_MANUFACTURER_PROPERTY_NAME,
        ...
        nx_azure_iot_json_writer_append_property_with_double_value(
            json_writer, (UCHAR *)DEVICE_INFO_TOTAL_STORAGE_PROPERTY_NAME,
            sizeof(DEVICE_INFO_TOTAL_STORAGE_PROPERTY_NAME) - 1, DEVICE_INFO_TOTAL_STORAGE_PROPERTY_VALUE, 2) ||
        nx_azure_iot_json_writer_append_property_with_double_value(
            json_writer, (UCHAR *)DEVICE_INFO_TOTAL_MEMORY_PROPERTY_NAME,
            sizeof(DEVICE_INFO_TOTAL_MEMORY_PROPERTY_NAME) - 1, DEVICE_INFO_TOTAL_MEMORY_PROPERTY_VALUE, 2))
    {
...
static UINT append_device_telemetry_magnetometer(NX_AZURE_IOT_JSON_WRITER *json_writer)
{
    ...
    if (nx_azure_iot_json_writer_append_property_with_double_value(json_writer, (UCHAR *)TELEMETRY_MAGNETOMETERX,
                                                                   sizeof(TELEMETRY_MAGNETOMETERX) - 1,
                                                                   lis2mdl_data.magnetic_mG[0], 2) ||

        nx_azure_iot_json_writer_append_property_with_double_value(json_writer, (UCHAR *)TELEMETRY_MAGNETOMETERY,
                                                                   sizeof(TELEMETRY_MAGNETOMETERY) - 1,
                                                                   lis2mdl_data.magnetic_mG[1], 2) ||

        nx_azure_iot_json_writer_append_property_with_double_value(json_writer, (UCHAR *)TELEMETRY_MAGNETOMETERZ,
                                                                   sizeof(TELEMETRY_MAGNETOMETERZ) - 1,
                                                                   lis2mdl_data.magnetic_mG[2], 2))
    {
        return NX_NOT_SUCCESSFUL;
    }
...
static UINT append_device_telemetry_accelerometer(NX_AZURE_IOT_JSON_WRITER *json_writer)
{
    ...
    if (nx_azure_iot_json_writer_append_property_with_double_value(json_writer, (UCHAR *)TELEMETRY_ACCELEROMETERX,
                                                                   sizeof(TELEMETRY_ACCELEROMETERX) - 1,
                                                                   lsm6dsl_data.acceleration_mg[0], 2) ||

        nx_azure_iot_json_writer_append_property_with_double_value(json_writer, (UCHAR *)TELEMETRY_ACCELEROMETERY,
                                                                   sizeof(TELEMETRY_ACCELEROMETERY) - 1,
                                                                   lsm6dsl_data.acceleration_mg[1], 2) ||

        nx_azure_iot_json_writer_append_property_with_double_value(json_writer, (UCHAR *)TELEMETRY_ACCELEROMETERZ,
                                                                   sizeof(TELEMETRY_ACCELEROMETERZ) - 1,
                                                                   lsm6dsl_data.acceleration_mg[2], 2))
    {
        return NX_NOT_SUCCESSFUL;
    }
...
static UINT append_device_telemetry_gyroscope(NX_AZURE_IOT_JSON_WRITER *json_writer)
{
    ...
    if (nx_azure_iot_json_writer_append_property_with_double_value(json_writer, (UCHAR *)TELEMETRY_GYROSCOPEX,
                                                                   sizeof(TELEMETRY_GYROSCOPEX) - 1,
                                                                   lsm6dsl_data.angular_rate_mdps[0], 2) ||

        nx_azure_iot_json_writer_append_property_with_double_value(json_writer, (UCHAR *)TELEMETRY_GYROSCOPEY,
                                                                   sizeof(TELEMETRY_GYROSCOPEY) - 1,
                                                                   lsm6dsl_data.angular_rate_mdps[1], 2) ||

        nx_azure_iot_json_writer_append_property_with_double_value(json_writer, (UCHAR *)TELEMETRY_GYROSCOPEZ,
                                                                   sizeof(TELEMETRY_GYROSCOPEZ) - 1,
                                                                   lsm6dsl_data.angular_rate_mdps[2], 2))
    {
        return NX_NOT_SUCCESSFUL;
    }
...
static void command_received_cb(AZURE_IOT_NX_CONTEXT *nx_context_ptr, const UCHAR *component, USHORT component_length,
                                const UCHAR *method, USHORT method_length, UCHAR *payload, USHORT payload_length,
                                VOID *context_ptr, USHORT context_length)
{
    ...
    if (strncmp((CHAR *)method, SET_LED_STATE_COMMAND, method_length) == 0)
    {
        ...
        if ((status = nx_azure_iot_hub_client_command_message_response(&nx_context_ptr->iothub_client, 200, context_ptr,
                                                                       context_length, NULL, 0, NX_WAIT_FOREVER)))
        {
    ...
    else
    {
        ...
        if ((status = nx_azure_iot_hub_client_command_message_response(&nx_context_ptr->iothub_client, 501, context_ptr,
                                                                       context_length, NULL, 0, NX_WAIT_FOREVER)))
        {
            printf("Direct method response failed! (0x%08x)\r\n", status);
            return;
...
static void writable_property_received_cb(AZURE_IOT_NX_CONTEXT *nx_context, const UCHAR *component_name,
                                          UINT component_name_len, UCHAR *property_name, UINT property_name_len,
                                          NX_AZURE_IOT_JSON_READER *json_reader_ptr, UINT version)
{
    ...
    if (strncmp((CHAR *)property_name, TELEMETRY_INTERVAL_PROPERTY, property_name_len) == 0)
    {
        ...
        if (status == NX_AZURE_IOT_SUCCESS)
        {
            ...
            azure_nx_client_respond_int_writable_property(nx_context, NULL, TELEMETRY_INTERVAL_PROPERTY,
                                                          telemetry_interval, 200, version);
...
static void property_received_cb(AZURE_IOT_NX_CONTEXT *nx_context, const UCHAR *component_name, UINT component_name_len,
...
static void properties_complete_cb(AZURE_IOT_NX_CONTEXT *nx_context)
{
    ...
    azure_iot_nx_client_publish_int_writable_property(nx_context, NULL, TELEMETRY_INTERVAL_PROPERTY,
                                                      telemetry_interval);
